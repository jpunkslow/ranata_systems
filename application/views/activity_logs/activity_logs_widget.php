            ...
            <p>
                ...
                <span><?php
                    if ($log->log_type === "project_file") {
                        ...
                        echo lang($log->log_type) . ": " . modal_anchor(get_uri("projects/task_view"), " #" . $log->log_type_id . " - " . $log->log_type_title, array("title" => lang('task_info') . " #$log->log_type_id", "class" => "dark", "data-post-id" => $log->log_type_id));
                    } else {
                        echo lang($log->log_type) . ": " . nl2br($log->log_type_title);
                    }
                    ?></span>
                <?php
