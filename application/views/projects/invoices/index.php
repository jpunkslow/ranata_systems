...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#invoice-table").appTable({
            ...
            printColumns: combineCustomFieldsColumns([0, 3, 4, 5, 6, 7], '<?php echo $custom_field_headers; ?>'),
            xlsColumns: combineCustomFieldsColumns([0, 3, 4, 5, 6, 7], '<?php echo $custom_field_headers; ?>'),
