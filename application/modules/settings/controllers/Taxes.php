...
class Taxes extends MY_Controller {
    ...
    private function _make_row($data) {
        return array($data->title,
            ...
            modal_anchor(get_uri("settings/taxes/modal_form"), "<i class='fa fa-pencil'></i>", array("class" => "edit", "title" => lang('edit_tax'), "data-post-id" => $data->id))
            . js_anchor("<i class='fa fa-times fa-fw'></i>", array('title' => lang('delete_tax'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("settings/taxes/delete"), "data-action" => "delete"))
        );
    }
