        ...
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <div class="btn-group" role="group">
                    ...
                    <?php echo anchor(get_uri("vendor/view"), "<i class='fa fa-th-large'></i>", array("class" => "btn btn-default btn-sm")); ?>
                </div>
                <?php
                if ($this->login_user->is_admin) {
                    ...
                    echo modal_anchor(get_uri("vendor/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_vendor'), array("class" => "btn btn-default", "title" => lang('add_vendor')));
                }
                ?>
            </div>
        </div>
