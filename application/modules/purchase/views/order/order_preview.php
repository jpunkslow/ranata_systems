    ...
    <div class="invoice-preview">
            <div class="panel panel-default  p15 no-border clearfix">
                ...
                <div class="pull-right">
                    <?php
                    echo "<div class='text-center'>" . anchor("purchase/p_order/download_pdf/" . $invoice_info->id, lang("download_pdf"), array("class" => "btn btn-default round")) . "</div>"
                    ?>
                </div>
        ...
        if ($show_close_preview)
            echo "<div class='text-center'>" . anchor("purchase/p_order/view/" . $invoice_info->id, lang("close_preview"), array("class" => "btn btn-default round")) . "</div>"
            ?>
