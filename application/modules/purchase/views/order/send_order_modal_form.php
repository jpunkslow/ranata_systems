<?php echo form_open(get_uri("purchase/p_order/send_order"), array("id" => "send-invoice-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    ...
    <div class="form-group ml15">
        <i class='fa fa-check-circle' style="color: #5CB85C;"></i> <?php echo lang('attached') . ' ' . anchor(get_uri("purchase/p_order/download_pdf/" . $invoice_info->id), lang("invoice") . "-$invoice_info->id.pdf", array("target" => "_blank")); ?> 
    </div>
