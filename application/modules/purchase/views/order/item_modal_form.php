<?php echo form_open(get_uri("purchase/p_order/save_item"), array("id" => "order-item-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    ...
    function applySelect2OnItemTitle() {
        $("#invoice_item_title").select2({
            showSearchBox: true,
            ajax: {
                url: "<?php echo get_uri("purchase/p_order/get_item_suggestion"); ?>",
                dataType: 'json',
                quietMillis: 250,
            ...
            if (e.val === "+") {
                ...
                $.ajax({
                    url: "<?php echo get_uri("purchase/p_order/get_item_info_suggestion"); ?>",
