            ...
            <div class="title-button-group">
                <span class="dropdown inline-block">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li role="presentation"><?php echo anchor(get_uri("purchase/p_order/preview/" . $invoice_info->id ), "<i class='fa fa-search'></i> " . lang('invoice_preview'), array("title" => lang('invoice_preview')), array("target" => "_blank")); ?> </li>
