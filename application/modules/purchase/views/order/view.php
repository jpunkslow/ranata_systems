            ...
            <div class="title-button-group">
                <span class="dropdown inline-block">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li role="presentation"><?php echo anchor(get_uri("purchase/p_order/download_pdf/" . $invoice_info->id), "<i class='fa fa-download'></i> " . lang('download_pdf'), array("title" => lang('download_pdf'))); ?> </li>
                        <li role="presentation"><?php echo anchor(get_uri("purchase/p_order/preview/" . $invoice_info->id . "/1"), "<i class='fa fa-search'></i> " . lang('invoice_preview'), array("title" => lang('invoice_preview')), array("target" => "_blank")); ?> </li>
                        <li role="presentation" class="divider"></li>
                        <li role="presentation"><?php echo modal_anchor(get_uri("purchase/p_order/modal_form_edit"), "<i class='fa fa-edit'></i> " . lang('edit_invoice'), array("title" => lang('edit_invoice'), "data-post-id" => $invoice_info->id, "role" => "menuitem", "tabindex" => "-1")); ?> </li>

                        
                    </ul>
                </span>
                <?php echo modal_anchor(get_uri("purchase/p_order/item_modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_item'), array("class" => "btn btn-default", "title" => lang('add_item'), "data-post-invoice_id" => $invoice_info->id)); ?>
                <?php  echo modal_anchor(get_uri("purchase/p_order/send_order_modal_form/" . $invoice_info->id), "<i class='fa fa-envelope-o'></i> " . "Send Email Orders", array("class" => "btn btn-primary","title" => lang('email_invoice_to_vendor'), "data-post-id" => $invoice_info->id, "role" => "menuitem", "tabindex" => "-1")); ?>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#order-item-table").appTable({
            source: '<?php echo_uri("purchase/p_order/item_list_data/". $invoice_info->id) ?>',
            order: [[0, "asc"]],
            hideTools: true,
            columns: [
