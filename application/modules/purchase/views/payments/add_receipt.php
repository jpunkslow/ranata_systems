    ...
    <div class="panel panel-default">
        ...
        <div class="clearfix" style="font-size:14px;">
            ...
            <div class="form-group ">
                <label for="fid_cust" class="col-md-3">Nama Vendor</label>
                <div class=" col-md-7">
                    <?php
    ...
    $(document).ready(function () {
        ...
        $("#fid_cust").select2().on("change", function () {
            ...
            if ($(this).val()) {
                ...
                $.ajax({
                    url: "<?php echo get_uri("purchase/p_payments/list_data_receipt") ?>" + "/" + client_id,
                    dataType: "json",
                    // data: data,
                    type:'GET',
                    success: function (data) {

                        $("#invoices-table").load("<?php echo get_uri("purchase/p_payments/showTable/") ?>"+client_id);
