                    ...
                    <tr>
                        ...
                        <td class="text-center w50">
                            <a href="#" class="btn btn-primary" title="Mark As Pay" data-post-id="<?php echo $row->id ?>" data-act="ajax-modal" data-title="INVOICES <?php echo $row->code ?>" data-action-url="<?php echo get_uri("sales/s_payments/modal_form_pay") ?>"><i class="fa fa-money"></i></a>
                        </td>
                    </tr>
                <?php }
                    }else{ ?>
