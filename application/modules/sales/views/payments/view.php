    ...
    <div style="max-width: 1000px; margin: auto;">
        <div class="page-title clearfix mt15">
            ...
            <div class="title-button-group">
                ...
                <?php  echo modal_anchor(get_uri("sales/order/send_order_modal_form/" . $invoice_info->id), "<i class='fa fa-envelope-o'></i> " . lang('email_invoice_to_client'), array("class" => "btn btn-primary","title" => lang('email_invoice_to_client'), "data-post-id" => $invoice_info->id, "role" => "menuitem", "tabindex" => "-1")); ?>
            </div>
        </div>
