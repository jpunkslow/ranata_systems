<div style=" margin: auto;">
    <center><span style="font-size:16px;font-weight: bold;"><u>QUOTATION</u><br><?php echo $invoice_info->code; ?></span></center>
    <?php
    ...
    if ($invoice_style === "style_2") {
        $this->load->view('quotation_parts/header_style_2.php', $data);
    } else {
        $this->load->view('quotation_parts/header_style_1.php', $data);
    }
    ?>
</div>
