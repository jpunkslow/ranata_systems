...
class Income extends MY_Controller {
    ...
    function modal_form() {
        ...
        $view_data['coa_dropdown'] = $this->Master_Coa_Type_model->get_dropdown_list(array("account_number"));
    ...
    function modal_form_edit() {
        ...
        $view_data['model_info'] = $this->Income_model->get_details($options)->row();
    ...
    function list_data() {
        ...
        $list_data = $this->Income_model->get_details()->result();
        $result = array();
    ...
    private function _make_row($data) {
        ...
        if($data->status == 2){
        	...
        	$row_data[] = anchor(get_uri("accounting/income/view/").$data->id, "<i class='fa fa-eye'></i>", array("class" => "view", "title" => lang('view'), "data-post-id" => $data->id)).modal_anchor(get_uri("accounting/income/modal_form_edit"), "<i class='fa fa-pencil'></i>", array("class" => "edit", "title" => lang('edit_client'), "data-post-id" => $data->id))
