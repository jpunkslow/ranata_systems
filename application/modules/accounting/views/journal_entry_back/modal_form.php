<?php echo form_open(get_uri("accounting/journal_entry/add"), array("id" => "generalledger-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">

    

    <div class="form-group">
        <label for="code_voucher" class=" col-md-3">VOUCHER CODE</label>
        <div class="col-md-9">
            <?php
        ...
        $("#generalledger-form").appForm({
            onSuccess: function (result) {
                if (typeof RELOAD_VIEW_AFTER_UPDATE !== "undefined" && RELOAD_VIEW_AFTER_UPDATE) {
                    ...
                    window.location = "<?php echo site_url('accounting/journal_entry/jurnal_input/'); ?>" + result.id;
                }
            },
        });
