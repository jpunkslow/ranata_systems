<?php echo form_open(get_uri("accounting/expenses/add"), array("id" => "master_coa-form", "class" => "general-form", "role" => "form")); ?>
            ...
            <div class="form-group">
                ...
                <div class=" col-md-9">
                    ...
                    echo form_input(array(
                        ...
                        "name" => "voucher_code",
                        "class" => "form-control",
                        "value" => getCodeId('transaction_journal_header','VCE-'),
                        "data-rule-required" => true,
                        "readonly" => true,
