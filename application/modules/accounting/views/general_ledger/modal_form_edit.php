<?php echo form_open(get_uri("accounting/general_ledger/save"), array("id" => "generalledger-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    ...
    <div class="form-group">
        <label for="account_number" class=" col-md-3">Nomor Akun</label>
        <div class="col-md-9">
             <?php
            echo form_dropdown("account_number", $coa_dropdown, "", "class='select2 validate-hidden' id='account_number' data-rule-required='true', data-msg-required='" . lang('field_required') . "'");
            ?>
        </div>
    </div>
    <div class="form-group">
        <label for="account_name" class="col-md-3">Nama Akun</label>
        <div class=" col-md-9">
            <?php
            echo form_input(array(
                "id" => "account_name",
    ...
    <div class="form-group">
        <label for="position" class=" col-md-3">Posisi</label>
        <div class="col-md-9">
             <?php 
                echo form_dropdown(
                    "position", array(
     ...
     <div class="form-group">
        <label for="value" class="col-md-3">Jumlah</label>
        <div class=" col-md-9">
            <?php
            echo form_input(array(
                "id" => "value",
